...
void Bank::show(){
	...
	for(int i=0;i<total;i++){
		...
		cout<<"account num: "<<person[i].ID<<endl;
...
void Bank::update(){
	...
	cout<<"Enter account number those data you want to update"<<endl;
	...
	for(int i=0;i<total;i++){
		...
		cout<<"Data of account holder"<<i+1<<endl;
...
cout<<"Enter account number those data you want to search"<<endl;
	...
	cout<<"Enter account number..."<<endl;
     ...
     for(int i=0;i<total;i++){
     	...
     	if(id==person[i].ID){
		     ...
		     cout<<"Contact: "<<person[i].contact<<endl;
		     cout<<"available balance: "<<person[i].cash<<endl;
		     ...
		     switch(ch){
		     	...
		     	case '1':
		     		...
		     		cout<<"\nYour balance is..."<<person[i].cash<<endl;
		     	...
		     	case '2':
		     		...
		     		if(cash>person[i].cash){
		     			...
		     			cout<<"Your available balance is... "<<person[i].cash<<endl;
...
void Bank::del(){
	...
	cout<<"Enter account number those data you want to remove"<<endl;
